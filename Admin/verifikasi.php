            ...
            <div class="card border shadow-xs mb-4">
                <div class="card-header border-bottom pb-0">
                    <div class="d-sm-flex align-items-center mb-3">
                        <div>
                            <h6 class="font-weight-semibold text-lg mb-0">Verification form</h6>
                            <p class="text-sm mb-sm-0">waste demand verification</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body px-0 py-0">
                        <div class="table-responsive p-0">
                            <form action="proses_verifikasi.php" method="post">
                                <input type="hidden" name="id_kebutuhan" value="<?php echo $row['id_kebutuhan']; ?>">
                                <table class="table align-items-center justify-content-center mb-0">
                                    ...
                                    <tbody>
                                        <!-- Tampilkan data dari tabel kebutuhan_sampah -->
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2">
                                                    <div class="my-auto">
                                                        <h6 class="mb-0 text-sm">Type of Waste</h6>
                                                    </div>
                                                    <input type="text" name="jenis_sampah"
                                                        class="form-control form-control-sm ms-2"
                                                        placeholder="Jenis Sampah"
                                                        value="<?php echo $row['jenis_sampah']; ?>" readonly>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex px-2">
                                                    ...
                                                    <input type="number" name="jumlah_sampah"
                                                        ...
                                                        value="<?php echo $row['jumlah_sampah']; ?>" readonly>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2">
                                                    <div class="my-auto">
                                                        <h6 class="mb-0 text-sm">Unit of Waste in weight</h6>
                                                    </div>
                                                    <select name="satuan_sampah"
                                                        class="form-control form-control-sm ms-2"
                                                        <?php echo ($row['status_kebutuhan'] == 'menunggu verifikasi') ? 'disabled' : ''; ?>>
                                                        <option value="g"
                                                            <?php echo ($row['satuan_sampah'] == 'g') ? 'selected' : ''; ?>>
                                                            Gram</option>
                                                        <option value="kg"
                                                            <?php echo ($row['satuan_sampah'] == 'kg') ? 'selected' : ''; ?>>
                                                            Kilogram</option>
                                                        <option value="ton"
                                                            <?php echo ($row['satuan_sampah'] == 'ton') ? 'selected' : ''; ?>>
                                                            Ton</option>
                                                    </select>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex px-2">
                                                    <div class="my-auto">
                                                        <h6 class="mb-0 text-sm">Date of Requirement</h6>
                                                    </div>
                                                    <input type="date" name="tanggal_kebutuhan"
                                                        class="form-control form-control-sm ms-2"
                                                        placeholder="Tanggal Kebutuhan"
                                                        value="<?php echo $row['tanggal_kebutuhan']; ?>"
                                                        <?php echo ($row['status_kebutuhan'] == 'menunggu verifikasi') ? 'readonly' : ''; ?>>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <button type="submit" name="setujui"
                                                    class="btn btn-success btn-sm ms-auto">Approve</button>
                                                <button type="submit" name="tolak"
                                                    class="btn btn-danger btn-sm ms-2">Reject</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>

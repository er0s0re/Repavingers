                ...
                <div class="col-md-12">
                    <div class="d-md-flex align-items-center mb-3 mx-2">
                        <div class="mb-md-0 mb-3">
                            ...
                            <p class="mb-0">Dashboard admin repavingers!</p>
                        </div>
                        <button type="button"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        ...
                                        <!-- Ganti $700 dengan data yang sesuai dari tabel penjual sampah -->
                                        <h4 class="mb-2 font-weight-bold">
                                            <?php
                // Ambil jumlah user dari tabel penjual sampah
                $queryUserCount = "SELECT COUNT(*) as total_users FROM penjual_sampah";
                $resultUserCount = mysqli_query($koneksi, $queryUserCount);

                if ($resultUserCount) {
                    $rowUserCount = mysqli_fetch_assoc($resultUserCount);
                    echo $rowUserCount['total_users'];
                } else {
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Community</p>
                                        <h4 class="mb-2 font-weight-bold">
                                            <?php
                // Ambil jumlah user dari tabel penjual sampah
                $queryUserCount = "SELECT COUNT(*) as total_komunitas FROM komunitas";
                $resultUserCount = mysqli_query($koneksi, $queryUserCount);

                if ($resultUserCount) {
                    $rowUserCount = mysqli_fetch_assoc($resultUserCount);
                    echo $rowUserCount['total_komunitas'];
                } else {
                    echo "Error: " . mysqli_error($koneksi);
                }
                ?>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        ...
                                        <h4 class="mb-2 font-weight-bold">
                                            <?php
                // Ambil jumlah verifikasi pending dari tabel kebutuhan_sampah
                $queryPendingVerifications = "SELECT COUNT(*) as pending_verifications FROM kebutuhan_sampah WHERE status_kebutuhan = 'menunggu verifikasi'";
                $resultPendingVerifications = mysqli_query($koneksi, $queryPendingVerifications);

                if ($resultPendingVerifications) {
                    $rowPendingVerifications = mysqli_fetch_assoc($resultPendingVerifications);
                    echo $rowPendingVerifications['pending_verifications'];
                } else {
                    echo "Error: " . mysqli_error($koneksi);
                }
                ?>

        ...
        <nav class="navbar navbar-main navbar-expand-lg mx-5 px-0 shadow-none rounded" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-2">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bold mb-0">Laporan</h6>
                </nav>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Admin Information</h6>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">
                                                        <?php echo $rowAdmin['nama_admin']; ?></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">
                                                        <?php echo $rowAdmin['email_admin']; ?></p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>

        ...
        <nav class="navbar navbar-main navbar-expand-lg mx-5 px-0 shadow-none rounded" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-2">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bold mb-0">Order</h6>
                </nav>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Waste form</h6>
                                    <p class="text-sm mb-sm-0">Order form for waste requirements</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table align-items-center justify-content-center mb-0">
                                        ...
                                        <tbody>
                                                    ...
                                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                                                        ...
                                                        <div class="d-flex px-2">
                                                            ...
                                                            <input type="text" name="jenis_sampah"
                                                                ...
                                                                placeholder="Jenis Sampah" value="Plastik" readonly>
                                                        </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex px-2">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <button type="submit"
                                                        class="btn btn-primary btn-sm ms-auto">Send</button>
                                                </td>
                                            </tr>
                                            </form>
                                        </tbody>

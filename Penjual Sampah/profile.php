...
$id_penjual = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : null;
$queryUser = "SELECT * FROM penjual_sampah WHERE id_penjual = $id_penjual";
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">User Information</h6>
                                    ...
                                    <table class="table align-items-center justify-content-center mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">
                                                        <?php echo $rowUser['nama_penjual']; ?></p>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">
                                                        <?php echo $rowUser['alamat_penjual']; ?></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">
                                                        <?php echo $rowUser['email_penjual']; ?></p>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">
                                                        <?php echo $rowUser['telepon_penjual']; ?></p>
                                                </td>
                                            </tr>

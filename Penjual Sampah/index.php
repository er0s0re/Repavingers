...
<body class="g-sidenav-show  bg-gray-100">
                ...
                <div class="col-md-12">
                    <div class="d-md-flex align-items-center mb-3 mx-2">
                        <div class="mb-md-0 mb-3">
                            ...
                            <p class="mb-0">Dashboard User repavingers!</p>
                        </div>
                        <button type="button"
    ...
    <div class="col-12">
        <div class="w-100">
            ...
            <!-- Ganti $700 dengan data yang sesuai dari tabel penjualan_sampah -->
            <h4 class="mb-2 font-weight-bold">
            <?php
                // Ambil total jumlah transaksi dari tabel penjualan_sampah dengan status_penjual disetujui
                $id_penjual = $_SESSION['user_id']; // Ganti sesuai dengan struktur sesi Anda

                $queryTotalTransaksi = "SELECT COUNT(*) as total_transaksi FROM penjualan_sampah WHERE id_penjual = '$id_penjual' AND status_penjualan = 'disetujui'";
                $resultTotalTransaksi = mysqli_query($koneksi, $queryTotalTransaksi);

                if ($resultTotalTransaksi) {
                    $rowTotalTransaksi = mysqli_fetch_assoc($resultTotalTransaksi);
                    echo $rowTotalTransaksi['total_transaksi'];
                } else {
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Total Waste Amount</p>
                                        <h4 class="mb-2 font-weight-bold">
                                        <?php
                // Ambil total jumlah sampah dari tabel penjualan_sampah dengan status_penjualan disetujui
                $id_penjual = $_SESSION['user_id']; // Ganti sesuai dengan struktur sesi Anda

                $queryTotalSampah = "SELECT SUM(jumlah_sampah) as total_jumlah_sampah FROM penjualan_sampah WHERE id_penjual = '$id_penjual' AND status_penjualan = 'disetujui'";
                $resultTotalSampah = mysqli_query($koneksi, $queryTotalSampah);

                if ($resultTotalSampah) {
                    $rowTotalSampah = mysqli_fetch_assoc($resultTotalSampah);
                    echo $rowTotalSampah['total_jumlah_sampah'] . ' kg';
                } else {
                    echo "Error: " . mysqli_error($koneksi);
                }
                ?>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Factory</p>
                                        <h4 class="mb-2 font-weight-bold">
                                            <?php
                // Ambil jumlah user dari tabel penjual sampah
                $queryUserCount = "SELECT COUNT(*) as total_pabrik FROM pabrik_paving";
                $resultUserCount = mysqli_query($koneksi, $queryUserCount);

                if ($resultUserCount) {
                    $rowUserCount = mysqli_fetch_assoc($resultUserCount);
                    echo $rowUserCount['total_pabrik'];
                } else {
                    echo "Error: " . mysqli_error($koneksi);
                }
                ?>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Pending Verifications</p>
                                        <!-- Ganti "Total Users" dengan data yang sesuai dari tabel kebutuhan_sampah -->
                                        <h4 class="mb-2 font-weight-bold">
                                        <?php
                // Ambil total transaksi penjualan sampah dari tabel penjualan_sampah dengan status_penjualan menunggu verifikasi
                $id_penjual = $_SESSION['user_id']; // Ganti sesuai dengan struktur sesi Anda

                $queryTotalTransaksi = "SELECT COUNT(*) as total_transaksi FROM penjualan_sampah WHERE id_penjual = '$id_penjual' AND status_penjualan = 'menunggu verifikasi'";
                $resultTotalTransaksi = mysqli_query($koneksi, $queryTotalTransaksi);
                    ...
                    <div class="col-md-12">
                        <div class="d-md-flex align-items-center mb-3 mx-2">
                            <div class="mb-md-0 mb-3">
                                ...
                                <p class="mb-0">Needs required by the paving factory which need to be met immediately on
                                    time!</p>
                            </div>
                        </div>
                    </div>

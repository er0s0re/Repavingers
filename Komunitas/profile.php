...
$id_Komunitas = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : null;
$queryKomunitas = "SELECT * FROM komunitas WHERE id_Komunitas = $id_Komunitas";
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">community Information</h6>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">
                                                        <?php echo $rowKomunitas['nama_komunitas']; ?></p>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2">
                                                        <div class="my-auto">
                                                            <h6 class="mb-0 text-sm">Community Email</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">
                                                        <?php echo $rowKomunitas['email_komunitas']; ?></p>
                                                </td>

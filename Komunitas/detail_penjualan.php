...
<body class="g-sidenav-show  bg-gray-100">
            ...
            <div class="container-fluid py-1 px-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-1 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Detail Information</li>
                    </ol>
                    <h6 class="font-weight-bold mb-0">Detail Information</h6>
                </nav>
        ...
        <div class="container-fluid py-4 px-5">
            ...
            <div class="row">
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Seller Information</h6>
                                    <p class="text-sm mb-sm-0">Seller information about the waste sold</p>
                                </div>
                            </div>
                        </div>
                ...
                if ($rowPenjual = mysqli_fetch_assoc($resultPenjual)) {
                    echo '<p class="text-sm font-weight-normal mb-0">' . $rowPenjual['nama_penjual'] . '</p>';
                } else {
                    echo '<p class="text-sm font-weight-normal mb-0">Informasi penjual tidak ditemukan.</p>';
                }
                ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2">
                                                        <div class="my-auto">
                                                            <h6 class="mb-0 text-sm">Seller's address</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                ...
                if ($rowPenjual = mysqli_fetch_assoc($resultPenjual)) {
                    echo '<p class="text-sm font-weight-normal mb-0">' . $rowPenjual['alamat_penjual'] . '</p>';
                } else {
                    echo '<p class="text-sm font-weight-normal mb-0">Informasi penjual tidak ditemukan.</p>';
                }
                ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2">
                                                        <div class="my-auto">
                                                            <h6 class="mb-0 text-sm">Seller email</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                ...
                if ($rowPenjual = mysqli_fetch_assoc($resultPenjual)) {
                    echo '<p class="text-sm font-weight-normal mb-0">' . $rowPenjual['email_penjual'] . '</p>';
                } else {
                    echo '<p class="text-sm font-weight-normal mb-0">Informasi penjual tidak ditemukan.</p>';
                }
                ?>
                ...
                if ($rowPenjual = mysqli_fetch_assoc($resultPenjual)) {
                    echo '<p class="text-sm font-weight-normal mb-0">' . $rowPenjual['telepon_penjual'] . '</p>';
                } else {
                    echo '<p class="text-sm font-weight-normal mb-0">Informasi penjual tidak ditemukan.</p>';
                }
                ?>
                ...
                <div class="col-12">
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Sales Waste Information</h6>
                                    <p class="text-sm mb-sm-0">garbage information about the garbage sold</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-body px-0 py-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2">
                                                        <div class="my-auto">
                                                            <h6 class="mb-0 text-sm">Amount of Waste</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">
                                                        <?php echo $jumlah_sampah . ' ' . $satuan_sampah; ?></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2">
                                                        <div class="my-auto">
                                                            <h6 class="mb-0 text-sm">Sales Status</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">
                                                        <?php echo $status_penjualan; ?></p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                ...
                <div class="col-12">
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Photo Information</h6>
                                    <p class="text-sm mb-sm-0">photographic evidence of garbage</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-body px-0 py-0">
                                    ...
                                    <table class="table align-items-center justify-content-center mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                    $fotoPath = "../image/bukti_sampah/" . $foto_sampah; // Path relatif ke gambar
                                    if (file_exists($fotoPath)) {
                                        echo "<img src='$fotoPath' alt='Foto Sampah' style='max-width: 100%; height: auto;'>";
                                    } else {
                                        echo '<div class="alert alert-danger" role="alert">Foto tidak tersedia.</div>';
                                    }
                                    ?>
                                                </td>
                                            </tr>
    ...
    <div class="card border shadow-xs mb-4">
        <div class="card-header border-bottom pb-0">
            <div class="d-sm-flex align-items-center mb-3">
                <div>
                    <h6 class="font-weight-semibold text-lg mb-0">Map</h6>
                    <p class="text-sm mb-sm-0">map to the seller address</p>
                </div>
            </div>
        </div>
        <div class="card-body px-0 py-0">
            <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0">
                    ...
                    <tbody>
                        ...
                        <!-- Add other rows for Nama Penjual, Alamat Penjual, Email Penjual, Telepon Penjual here -->
                        <tr>
                            <td>
                                <div class="d-flex px-2">
                                    <div class="my-auto">
                                ...
                                <?php if ($status_penjualan == 'menunggu verifikasi') : ?>
                                    <form method="post" class="mt-4">
                                        <button type="submit" name="action" value="disetujui"
                                            class="btn btn-success">Disetujui</button>

            ...
            <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-black text-dark display-6">Let's Go Back</h3>
                  <p class="mb-0">Welcome Repavingers! Please enter your details.</p>
                </div>
                <div class="card-body">
                  <form role="form" method="POST" action="login1.php">
                    ...
                    <div class="text-center">
                      <button  type="submit" name="login" class="btn btn-dark w-100 mt-4 mb-3">Sign in</button>
                    </div>
                  </form>
                </div>
              ...
              <div class="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                <div class="oblique-image position-absolute fixed-top ms-auto h-100 z-index-0 bg-cover ms-n8" style="background-image:url('assets/img/image-sign-in.jpg')">
                  <div class="blur mt-12 p-4 text-center border border-white border-radius-md position-absolute fixed-bottom m-4">
                    <h2 class="mt-3 text-dark font-weight-bold">Repavingers are a great way to reduce waste and protect the environment.</h2>
                    <h6 class="text-dark text-sm mt-5">Copyright © 2024 Repavingers.</h6>
                  </div>
                </div>
              </div>
            </div>
